    ...
    <div className="flex items-center justify-between">
      ...
      <div>
        <select
          ...
          className="px-2 py-1 text-sm text-green-500 rounded-md  border"
        >
        ...
        {pages.pages.map((pageItem, index) => (
          <button
            ...
            className={clsx(
              ...
              {
                "text-green-500  hover:bg-gray-300": page === pageItem,
                "text-green-500  border  border-green-100/60": page !== pageItem,
              },
              {}
            )}
          >
