import { Controller, Post, Body, UseGuards, Get, Req, Param, Delete, Put, Query } from '@nestjs/common';
import { FindAllUserDto, LoginDto, RegisterDto, ResetPasswordDto } from './auth.dto';
...
export class AuthController {
  ...
  @Get('/list')
  findAllUser(@Query() query: FindAllUserDto) {
